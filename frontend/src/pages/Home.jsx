    ...
    return (
        <div className="home-page">
            ...
            <section className="home-cta-section">
                <Link to="/spiele" className="home-cta-card home-cta-local">
                    <div className="home-cta-border" aria-hidden="true" />
                    ...
                    <div className="home-cta-content">
                        ...
                        <div className="home-cta-text">
                            <h3 className="home-cta-title">Lokal spielen</h3>
                            <p className="home-cta-desc">
                                Würfle in Echt und trage deine Punkte digital ein. Perfekt für den Spieleabend am Tisch.
                            </p>
                        </div>
                        <div className="home-cta-features">
                            <span className="home-cta-feature">Kniffel & Phase 10</span>
                            <span className="home-cta-feature">Live-Scoreboard</span>
                            <span className="home-cta-feature">Zuschauer-Ansicht</span>
                        </div>
                ...
                <Link to="/multiplayer" className="home-cta-card home-cta-multi">
                    <div className="home-cta-border" aria-hidden="true" />
                    <div className="home-cta-glow" aria-hidden="true" />
                    <div className="home-cta-content">
                        <div className="home-cta-icon">
                        ...
                        <div className="home-cta-text">
                            <h3 className="home-cta-title">Online Multiplayer</h3>
                            <p className="home-cta-desc">
                                Spiele zusammen mit Freunden online. Erstelle Räume, tritt bei und würfle digital.
                            </p>
                        </div>
                        <div className="home-cta-features">
                            <span className="home-cta-feature">6 Spiele verfügbar</span>
                            <span className="home-cta-feature">Digitale Würfel</span>
                            <span className="home-cta-feature">Raum-System</span>
                        </div>
                        <span className="home-cta-arrow">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M5 12h14" />
